...
from api import simulation, presets, health, social_security, tax_optimization, goals, enhanced_simulation, annuity, estate_planning
...
app.include_router(annuity.router, prefix="/api/annuity", tags=["annuity"])
app.include_router(estate_planning.router, prefix="/api/estate", tags=["estate-planning"])
